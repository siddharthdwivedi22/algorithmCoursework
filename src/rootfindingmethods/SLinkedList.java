...
public class SLinkedList {
    ...
    private void addFirst(Double element) {
        // make variable head point to new node
        head = new DoubleNode(element,head);
    }

    private void addLast(Double element) {
        DoubleNode tail;
        tail = head;
        ...
        tail.setNext( new DoubleNode(element,null));
    }
       ...
       // }
        //else {
          // throw new NoSuchElementException();
           //}
    //}
    public static void printList(SLinkedList thelist, int t) {
        DoubleNode temp;
        ...
        if(thelist.isEmpty())
            ...
            while (temp != null) {
               ...
               System.out.print("Iteration is " + t + "   "+  temp.getElement()+" ");
               temp = temp.getNext();
            }
            System.out.println();
        }
